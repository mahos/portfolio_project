...
$(document).scroll(function() {
    ...
    if (!$('#uxuiWorkCard2').hasClass('scrolled-in')) {
        if ($(document).scrollTop() >=  $('#uxuiWorkCard2').offset().top - ($('#uxuiWorkCard2').outerHeight() * 1.3)) {
            // console.log('scrolltop: ', $(document).scrollTop(), ' / card 2 offset.top: ', $('#uxuiWorkCard2').offset().top, ' / outerHeight:', $('#uxuiWorkCard2').outerHeight())
    ...
    if (!$('#uxuiWorkCard3').hasClass('scrolled-in')) {
        if ($(document).scrollTop() >=  $('#uxuiWorkCard3').offset().top - ($('#uxuiWorkCard3').outerHeight() * 1.3)) {
            ...
            // console.log('scrolltop: ', $(document).scrollTop(), ' / card 3 offset.top: ', $('#uxuiWorkCard3').offset().top, ' / outerHeight:', $('#uxuiWorkCard3').outerHeight())
    ...
    if (!$('#uxuiWorkCard4').hasClass('scrolled-in')) {
        if ($(document).scrollTop() >=  $('#uxuiWorkCard4').offset().top - ($('#uxuiWorkCard4').outerHeight() * 1.3)) {
            // console.log('scrolltop: ', $(document).scrollTop(), ' / card 4 offset.top: ', $('#uxuiWorkCard4').offset().top, ' / outerHeight:', $('#uxuiWorkCard4').outerHeight())
